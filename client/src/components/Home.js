...
function Home() {
  ...
  //       data: [250, 300, 360, 519, 462, 272, 379, 452, 206],
  //       backgroundColor: [
  //         "rgba(255, 99, 132, 0.8)",
  //         "rgba(54, 162, 235, 0.8)",
  //         "rgba(255, 206, 86, 0.8)",
  ...
  //           <h1>Home Automation Using BlockChain</h1>
  //           <div className="climate">
  //             <img src="https://www.transparentpng.com/thumb/weather-report/android-weather-icons-png-12.png" alt="a"/>
  ...
  //           <div>
  //             <span className="spant">Current User</span>
  //           </div>
  //         </div>
  //         <div className="date">
  //         <h2>Date : {date}</h2>
  //         <h2>Time : <Clock format={'HH:mm:ss'} ticking={true} timezone={'IST'}/> </h2>
  //         </div>
  //       </div>
  //     </div>
  //   </div>
  ...
  return (
    <div className="App">
      <Navbar />
      <div className="main">
        <div style={{display:"flex",justifyContent:"center",width:"100%",fontFamily: "Oswald"}}>
          <h1>Home Automation Using Blockchain</h1>
        </div>
        <div className="profile2out">
          <div className="profile2">
            <img
              src="data:image/png;base64,"
              alt="b"
            />
            <div>
              <span className="spant">Current User</span>
        ...
        <div className="climateout">
          <div className="climate">
              <span>Temperature is <span style={{color: "orange"}}>{temp}°C</span></span>
              <span>Humidity is <span style={{color: "pink"}}>{hum}%</span></span>
          </div>
        </div>
